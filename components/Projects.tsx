            ...
            <div key={index} className="project-card">
              ...
              <div className="project-card-image">
                {project.images && project.images.length > 0 ? (
                  <img src={project.images[0]} alt={project.title} className="card-cover" />
                ) : (
                  <div className="card-placeholder">
                    <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="var(--border-color)" strokeWidth="1">
                ...
                {project.status && (
                  <div className={`project-status status-${project.status}`}>
                    <span className={`status-dot dot-${project.status}`}></span>
              ...
              <div className="project-content">
                <h3 className={`project-title title-${project.status}`}>{project.title}</h3>
              ...
              <div className="project-footer">
                <div className="project-links-left">
                  {project.liveUrl && (
                    <a href={project.liveUrl} target="_blank" rel="noopener noreferrer" aria-label="Live Demo" className="circle-link">
                  ...
                  {project.githubUrl && (
                    <a href={project.githubUrl} target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="circle-link">
                  ...
                  {project.mlUrl && (
                    <a href={project.mlUrl} target="_blank" rel="noopener noreferrer" aria-label="ML Model" className="circle-link">
                      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                ...
                {project.videoUrl && (
                  <div className="project-links-right">
                    <a href={project.videoUrl} target="_blank" rel="noopener noreferrer" className="demo-btn">
